...
flags.DEFINE_string('video', './data/video/VehicleTest.mp4', 'path to input video or set to 0 for webcam')
flags.DEFINE_string('output', './outputs/VehicleTest.avi', 'path to output video file')
...
def main(_argv):
    ...
    frame_num = 0
    hf = h5py.File('./outputs/data.h5', 'w')
    d1 = []
